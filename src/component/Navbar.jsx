...
const Navbar = () => {
  ...
  return (
    <nav className={`p-1 flex fixed  items-center z-40 container ${isTransparent ? 'bg-transparent' : 'bg-[#DBE1E9]'}`}>
      <div className="flex items-center flex-row">
        <img src={Logo} alt="Logo" className="h-26 w-28 mr-2" />
      </div>
      <ul className="ml-4 flex space-x-4 z-30 ">
  <li>
    <Link to="/landing" className="text-primary font-poppins font font-semibold">
      Home
    </Link>
  </li>
  <li>
