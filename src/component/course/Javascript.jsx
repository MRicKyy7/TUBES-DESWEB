    ...
    <>
      <div className="px-16 py-20">
        <div className="w-96 h-[450px] relative bg-transparent ml-60 mt-10 mb-10">
          ...
          <img src={imgJS} alt="imgJS" className="relative px-4 left-20 -ml-1 top-10" />
          <div>
            ...
            <Link as={Link} to={"/Login"}>
              <button>
                <img
                  src={cart}
                  alt="imgCart"
                  className=" absolute right-4 -bottom-2 bg-slate-200  active:bg-slate-300 focus:outline-none focus:ring "
                />
              </button>
            </Link>
          </div>
