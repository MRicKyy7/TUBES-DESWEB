    ...
    <section className="bg-white flex flex-col">
      ...
      <div className="self-center w-full max-w-6xl px-5 max-md:max-w-full">
        <div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
          <nav className="flex flex-col items-stretch w-[21%] max-md:w-full max-md:ml-0">
            <ul className="justify-center text-black text-2xl font-semibold leading-7 max-w-[292px] max-md:mt-10">
              <li>Home</li>
              <li>Program</li>
              <li>Contact</li>
              <li>About</li>
              ...
              <div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
                <div className="flex flex-col items-stretch w-[73%] max-md:w-full max-md:ml-0">
                  <address className="justify-center text-black text-2xl leading-7 max-w-[445px] max-md:mt-10">
                    Jl. Sei Wain, Karang Joang, Kec. Balikpapan Utara, Kota Balikpapan, Kalimantan Timur 76127
                    <br />
                ...
                <div className="flex flex-col items-stretch w-[9%] ml-5 max-md:w-full max-md:ml-0">
                  <img
                    loading="lazy"
                    srcSet="https://cdn.builder.io/api/v1/image/assets/TEMP/442aaa80-5278-4760-96ad-f97f0ef4b294?apiKey=23fb824677004c86b8742e2f02c99782&width=100 100w, https://cdn.builder.io/api/v1/image/assets/TEMP/442aaa80-5278-4760-96ad-f97f0ef4b294?apiKey=23fb824677004c86b8742e2f02c99782&width=200 200w, https://cdn.builder.io/api/v1/image/assets/TEMP/442aaa80-5278-4760-96ad-f97f0ef4b294?apiKey=23fb824677004c86b8742e2f02c99782&width=400 400w, https://cdn.builder.io/api/v1/image/assets/TEMP/442aaa80-5278-4760-96ad-f97f0ef4b294?apiKey=23fb824677004c86b8742e2f02c99782&width=800 800w, https://cdn.builder.io/api/v1/image/assets/TEMP/442aaa80-5278-4760-96ad-f97f0ef4b294?apiKey=23fb824677004c86b8742e2f02c99782&width=1200 1200w, https://cdn.builder.io/api/v1/image/assets/TEMP/442aaa80-5278-4760-96ad-f97f0ef4b294?apiKey=23fb824677004c86b8742e2f02c99782&width=1600 1600w, https://cdn.builder.io/api/v1/image/assets/TEMP/442aaa80-5278-4760-96ad-f97f0ef4b294?apiKey=23fb824677004c86b8742e2f02c99782&width=2000 2000w, https://cdn.builder.io/api/v1/image/assets/TEMP/442aaa80-5278-4760-96ad-f97f0ef4b294?apiKey=23fb824677004c86b8742e2f02c99782&"className="aspect-[1.24] object-contain object-center w-[61px] overflow-hidden max-w-full my-auto max-md:mt-10"
                    alt="Logo 2"
                  />
                </div>
                <div className="flex flex-col items-stretch w-[9%] ml-5 max-md:w-full max-md:ml-0">
      ...
      <footer className="bg-gray-400 self-stretch flex w-full flex-col mt-24 px-20 py-2 max-md:max-w-full max-md:mt-10 max-md:px-5">
        <p className="text-white text-2xl leading-7 self-center whitespace-nowrap max-md:max-w-full">
          Copyright © 2023 Kelompok-6 -Desain-Website.ITK. All Rights Reserved
        </p>
      </footer>
    </section>
  );
